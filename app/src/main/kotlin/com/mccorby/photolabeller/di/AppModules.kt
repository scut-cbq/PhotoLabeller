...
class MainLabellingModule : LabellingModule, Injects<AndroidModule> {
    ...
    private val dataSource by required { dataSource }
    ...
    private val getModelFromServer get() = GetModelFromServer(dataSource, trainer, executionContext, postExecutionContext)
